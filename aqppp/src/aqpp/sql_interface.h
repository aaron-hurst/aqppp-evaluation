...
namespace aqppp {
	...
	public:
		...
		*/
		...
		static std::string ComputeRandStr(SQLHANDLE& sqlConnectionHandle, std::string table_name, int seed, double sample_rate);
		...
		static double CreateDbSample(SQLHANDLE &sqlconnectionhandle, int seed, std::string db_name, std::string table_name, double sample_rate, std::string sample_name);
