...
namespace expDemo {
	...
	double QueryRealValue(const std::vector<aqppp::Condition>& cur_q, std::string table_name, SQLHANDLE& sqlconnectionhandle, const aqppp::Settings PAR, std::string agg_action);
